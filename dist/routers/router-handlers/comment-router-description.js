...
const getCommentById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.status(http_statuses_1.HttpStatus.Ok).send(result);
});
...
const updateCommentById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield command_repository_1.dataCommandRepository.updateCommentById(req.params[id_names_1.IdParamName.CommentId], req.user.userId, req.body);
